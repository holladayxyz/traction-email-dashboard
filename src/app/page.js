...
const WEEKS = {
  ...
  "week-6": {
    ...
    campaigns: [
      ...
      },
      {
        ...
        rpr: 0.04,
        aov: 77.54,
        tag: { label: "Follow-Up", color: BRAND.blue },
        insight: "Day-2 scarcity follow-up captured an additional $1,318 in revenue from the same SMS list that already converted heavily on launch day. Conversions dropped from 56 to 17, which is expected after a strong Day 1 — most high-intent buyers acted immediately. Combined two-day SMS total: $5,904 from ~30K contacts. For future promo windows, a 48-hour gap between SMS sends may preserve more urgency for the second touch.",
      },
      {
        name: "Mar 10 SMS",
        sendDate: "Mar 10",
        ...
        rpr: 0.04,
        aov: 67.59,
        tag: { label: "Steady Close", color: BRAND.blue },
        insight: "Post-promo SMS still delivered $1,217 in revenue and 18 conversions — holding steady after the main campaign window closed. Click rate at 0.54% was lower than launch day, but this send extended the total SMS campaign revenue to $7,121 across three touches. For future campaigns, shifting the third SMS to a new angle (different product, cross-sell) could re-engage the audience beyond the original promo.",
      },
    ],
    insights: [
      ...
      { icon: "📊", title: "SMS drove $7,121 across the St. Paddy's window — email follow-ups showed diminishing returns", body: "SMS delivered $7,121 in total campaign revenue across three sends, with the majority ($4,586) converting on Day 1. Email followed a steeper decline: $5,196 (Mar 6) → $3,667 (Mar 7) → $2,454 (Mar 9), with CTO dropping from 0.99% to 0.48% by the third send. The data confirms SMS captures high-intent buyers faster than email on launch day, while email follow-ups past Day 2 hit diminishing returns. Future promo windows should lead with SMS on Day 1 and limit email to 2 sends max.", borderColor: BRAND.amber },
  ...
  "week-7": {
    ...
    campaigns: [
      {
        name: "What's Waiting at the End of the Rainbow?",
        sendDate: "Mar 12",
        recipients: 99016,
        delivered: 98512,
        openRate: 0.2323,
        ...
        aov: 77.49,
        tag: { label: "Top Performer", color: BRAND.green },
        insight: "St. Paddy's-themed send drove $5,734 on 74 conversions — the strongest revenue week since launch. Open rate of 23.2% and $77.49 AOV signal high-intent buyers responding to the seasonal angle.",
      },
      {
        name: "St. Paddy's Day SMS",
        sendDate: "Mar 13",
        recipients: 225,
        delivered: 225,
        openRate: null,
        ...
        aov: 0,
        tag: { label: "Baseline", color: BRAND.gray },
        insight: "225-subscriber SMS send for St. Paddy's Day. 8% click rate with no tracked conversions this window — typical for SMS without a hard discount attached.",
      },
    ],
    insights: [
      { icon: "✅", title: "Strongest revenue week to date", body: "The St. Patrick's Day email generated $5,734 from 74 conversions — the highest single-campaign revenue since the program launched. Seasonal hooks with a clear offer continue to outperform evergreen sends.", borderColor: BRAND.green },
      { icon: "📊", title: "23.2% open rate on 99K list", body: "Delivery rate held at 99.5% and open rate came in at 23.2% — slightly above the account's 30-day average of 24.9%. The rainbow/mystery angle in the subject line worked well at this list size.", borderColor: BRAND.blue },
      { icon: "💡", title: "SMS list still small — growth opportunity", body: "Only 225 SMS subscribers vs. 99K+ email. The St. Paddy's SMS had an 8% click rate but zero attributed revenue this window. Prioritizing SMS list growth will compound returns as flows and campaigns scale.", borderColor: BRAND.blue },
    ],
    flows: [
      {
        name: "Welcome Series",
      ...
      },
      {
        ...
        status: "LIVE",
        statusColor: BRAND.green,
        trigger: "Subscribed to SMS Marketing",
        launchDate: "Mar 10",
        smsLive: true,
        messages: [],
        note: "BAG QR FLOW launched Mar 10. SMS-only flow triggered on SMS subscribe via QR code on jerky bags. Revenue tracking pending — flow is live but conversions not yet attributed.",
      },
    ],
    checkoutDiagnostic: null,
    roadmap: {
      ...
      next: [
        { icon: "📦", label: "Scale QR bag program", desc: "BAG QR FLOW is live — monitor subscriber intake and first conversion data" },
        { icon: "📊", label: "Upload UTM registry spreadsheet", desc: "Central reference for all UTM naming conventions across paid channels" },
      ],
      later: [
        { icon: "📈", label: "Monitor source segment growth", desc: "Track how the 6 segments populate after form hidden fields go live" },
  ...
  "week-8": {
    label: "Week 8",
    dateRange: "Mar 19 – Mar 26",
    updatedDate: "Apr 9, 2026",
    campaigns: [
      {
        name: "Lucky 17 — 17% Off Sitewide",
        sendDate: "Mar 17",
        recipients: 99588,
        delivered: 99054,
        openRate: 0.2248,
        ...
        aov: 68.24,
        tag: { label: "Top Performer", color: BRAND.green },
        insight: "St. Patrick's Day promo with 17% sitewide discount drove $4,913 from 72 orders. Strong conversion rate relative to clicks — shoppers who clicked were highly primed to buy with the discount code.",
      },
      {
        name: "code LUCKY17 (SMS)",
        sendDate: "Mar 17",
        recipients: 225,
        delivered: 225,
        openRate: null,
        ...
        aov: 0,
        tag: { label: "Baseline", color: BRAND.gray },
        insight: "SMS companion to the Lucky 17 email sent to 225 subscribers with 12.9% click rate — well above typical SMS benchmarks. Conversion attribution unclear in this window.",
      },
      {
        name: "Why HBBQ Is Best Seller",
        sendDate: "Mar 26",
        recipients: 100081,
        delivered: 99574,
        openRate: 0.2242,
        ...
        aov: 88.74,
        tag: { label: "Click Gap", color: BRAND.amber },
        insight: "Strong open rate at 22.4% but click rate dipped to 0.11% — suggesting the subject/preview drove curiosity but the email body didn't close the loop. $88.74 AOV from 36 orders is excellent when someone did click.",
      },
    ],
    insights: [
      { icon: "✅", title: "Discount promo outperforms evergreen 2:1", body: "Lucky 17 (discount) generated $4,913 vs. $3,195 for the HBBQ storytelling send — a 54% revenue gap despite similar open rates. Discount-anchored emails are converting at higher rates when paired with a strong code.", borderColor: BRAND.green },
      { icon: "⚠️", title: "Click gap emerging on educational sends", body: "Why HBBQ Is Best Seller had a 22.4% open rate but only 0.11% click rate (CTO of 0.51%). The story is getting people to open but not click — the CTA placement or offer clarity may need work.", borderColor: BRAND.amber },
      { icon: "📊", title: "SMS click rate 13% vs. email 0.15%", body: "The LUCKY17 SMS drove a 12.9% click rate against email's 0.15% — an 86x difference. SMS subscribers are far more action-oriented. Growing this list is one of the highest-leverage moves available right now.", borderColor: BRAND.blue },
      { icon: "💡", title: "$88.74 AOV on HBBQ send — buyer quality is high", body: "Only 36 converted from the HBBQ email but they averaged $88.74 per order, the highest AOV this period. Storytelling emails may be attracting higher-intent, higher-spend buyers even at lower click volumes.", borderColor: BRAND.blue },
    ],
    flows: [
      {
        name: "Welcome Series",
      ...
      },
      {
        ...
        smsLive: true,
        messages: [],
        note: "BAG QR FLOW live since Mar 10. SMS-only triggered on QR bag scan SMS subscribe. Monitoring subscriber intake and first purchase data.",
      },
    ],
    checkoutDiagnostic: null,
    roadmap: {
      now: [
        { icon: "🔧", label: "Enable hidden UTM fields on Spin to Win form", desc: "Jake action item — unlocks full attribution on new subscribers" },
        { icon: "📈", label: "Optimize HBBQ-style email CTAs", desc: "Strong open rates but weak click rates suggest the body copy or CTA needs a clearer offer hook" },
      ],
      next: [
        { icon: "📦", label: "Scale QR bag program tracking", desc: "First week of live BAG QR FLOW — analyze early subscriber and conversion data" },
        { icon: "📊", label: "Upload UTM registry spreadsheet", desc: "Central reference for all UTM naming conventions across paid channels" },
      ],
      later: [
        { icon: "📈", label: "Monitor source segment growth", desc: "Track how the 6 segments populate after form hidden fields go live" },
  ...
  "week-9": {
    label: "Week 9",
    dateRange: "Mar 26 – Apr 2",
    updatedDate: "Apr 9, 2026",
    campaigns: [
      {
        name: "\"FLAVOR\" Four — Vote for Your Favorite",
        sendDate: "Mar 29",
        recipients: 100206,
        delivered: 99698,
        openRate: 0.248,
        ...
        aov: 78.19,
        tag: { label: "Strong Launch", color: BRAND.blue },
        insight: "Interactive Flavor Four voting campaign drove strong engagement — 24.8% open rate at 100K scale and $3,909 in revenue. The voting mechanic created anticipation for the winner announcement follow-up.",
      },
      {
        name: "t shirt bundle (SMS)",
        sendDate: "Mar 28",
        recipients: 361,
        delivered: 361,
        openRate: null,
        ...
        aov: 0,
        tag: { label: "Baseline", color: BRAND.gray },
        insight: "SMS blast to 361 subscribers for the T-shirt bundle with 8.9% click rate. List growth visible — up from 225 in March. Conversion attribution pending.",
      },
      {
        name: "Flavor Four Winner Announcement",
        sendDate: "Apr 1",
        recipients: 23773,
        delivered: 23745,
        openRate: 0.857,
        ...
        aov: 74.46,
        tag: { label: "Top Performer", color: BRAND.green },
        insight: "Segmented send to Flavor Four voters achieved an 85.7% open rate — the highest in Beefcake's history. The two-email sequence (vote + reveal) is a proven engagement playbook worth repeating for future product launches.",
      },
    ],
    insights: [
      { icon: "✅", title: "85.7% open rate — best in program history", body: "The Flavor Four Winner Announcement to 23,745 targeted recipients hit an 85.7% open rate. Segmented sends to engaged voters dramatically outperform full-list blasts — this two-email arc should become a repeatable playbook.", borderColor: BRAND.green },
      { icon: "📊", title: "Two-email arc generated $5,994 total", body: "The vote email ($3,909) + winner reveal ($2,085) combined for $5,994 across two sends — strong efficiency from one campaign concept. The sequence also generated 78 total conversions with AOVs above $74.", borderColor: BRAND.blue },
      { icon: "📈", title: "SMS list growing — 361 subscribers vs. 225 two weeks ago", body: "SMS list grew 60% in two weeks, from 225 to 361 subscribers. The T-shirt bundle SMS saw an 8.9% click rate. As the list scales toward 1K, SMS revenue contribution will become meaningful.", borderColor: BRAND.green },
      { icon: "💡", title: "Segmentation is the unlock", body: "The winner announcement to a 24K targeted segment outperformed full-list sends by 4x on open rate. Building more behavioral segments — buyers, browsers, high-AOV — will drive outsized returns as the list matures.", borderColor: BRAND.blue },
    ],
    flows: [
      {
        name: "Welcome Series",
      ...
      },
      {
        ...
        smsLive: true,
        messages: [],
        note: "BAG QR FLOW live. Monitoring first conversion data.",
      },
    ],
    checkoutDiagnostic: null,
    roadmap: {
      now: [
        { icon: "🎯", label: "Build Flavor Four repeat campaign arc", desc: "The vote + reveal format drove exceptional engagement — plan next interactive campaign" },
        { icon: "📈", label: "Optimize full-list email CTAs", desc: "Open rates are healthy at 22–25% but click rates are below 0.15% — body copy and CTA clarity need work" },
      ],
      next: [
        { icon: "📊", label: "Build buyer and high-AOV segments", desc: "Targeted sends like the winner announcement outperform full-list 4x — segment more aggressively" },
        { icon: "📦", label: "Analyze QR bag flow first conversions", desc: "BAG QR FLOW has been live 3+ weeks — pull first purchase data" },
      ],
      later: [
        { icon: "📈", label: "Monitor source segment growth", desc: "Track how the 6 segments populate after form hidden fields go live" },
        { icon: "🔄", label: "Replenish Shopify discount codes", desc: "Generate new batches as QR program scales" },
    ...
    campaigns: [
      {
        ...
        aov: 81.34,
        tag: { label: "Baseline", color: BRAND.gray },
        insight: "Product-launch email for the No BS Bundle hit 22% opens on 99K recipients. Lower conversion count (28) but strong $81.34 AOV suggests self-selectors for a premium bundle — this is early demand signal for the new product.",
      },
      {
        name: "NO BS BUNDLE (SMS)",
        sendDate: "Apr 3",
        recipients: 249,
        delivered: 249,
        openRate: null,
        ...
        aov: 0,
        tag: { label: "Baseline", color: BRAND.gray },
        insight: "SMS companion to the NO BS BUNDLE launch sent to 249 subscribers with 6% click rate and 15 attributed clicks. Revenue tracking pending for SMS conversions.",
      },
      {
        name: "\"Flair's Favorite is on Sale\" Email",
        sendDate: "Apr 8",
        recipients: 99936,
        delivered: 99527,
        openRate: 0.1992,
        ...
        aov: 112.19,
        tag: { label: "Fatigue Signal", color: BRAND.red },
        insight: "Open rate dropped to 19.9% — the lowest of any full-list send in the program. After 3 sends in 5 days (NO BS Bundle email + SMS + this), list fatigue is showing. Only 8 conversions despite 99K reach is a warning sign to reduce send frequency.",
      },
    ],
    insights: [
      { icon: "⚠️", title: "Open rate fell to 19.9% — fatigue signal", body: "Flair's Favorite hit a 19.9% open rate, the lowest full-list result since launch. This followed the NO BS Bundle email just 4 days earlier. The account's 30-day average is 24.9% — we're 5 points below it. Pull back send frequency.", borderColor: BRAND.red },
      { icon: "📊", title: "NO BS Bundle shows strong product-market fit", body: "28 conversions at $81.34 AOV for a new bundle product is a solid initial signal. The product email generated $2,277 — respectable for an awareness/launch send at 22% open rate.", borderColor: BRAND.blue },
      { icon: "💡", title: "$112 AOV on Flair's Favorite — segment the buyers", body: "Despite low volume (8 conversions), the buyers on Flair's Favorite averaged $112.19 per order — the highest AOV in the entire program. Segmenting and retargeting this buyer profile with premium offers could unlock outsized revenue.", borderColor: BRAND.green },
      { icon: "⚠️", title: "3 sends in 5 days is over-cadence for 100K list", body: "Apr 3 SMS + Apr 4 email + Apr 8 email = 3 touches in 5 days. The unsubscribe rate on the Apr 8 email is low (0.04%) but the open rate drop is a leading indicator. Aim for 1 email per 5–7 days on the full list.", borderColor: BRAND.amber },
    ],
    flows: [
      {
        name: "Welcome Series",
      ...
      },
      {
        ...
        smsLive: true,
        messages: [],
        note: "BAG QR FLOW live. Monitoring conversion data.",
      },
    ],
    checkoutDiagnostic: null,
    roadmap: {
      now: [
        { icon: "⚠️", label: "Reduce send frequency on full list", desc: "3 sends in 5 days drove open rate to 19.9% — space full-list emails to 1 per 5–7 days" },
        { icon: "🎯", label: "Segment Flair's Favorite buyers for premium retargeting", desc: "$112 AOV buyers are high-value — build a segment and target with premium bundles" },
      ],
      next: [
        { icon: "📊", label: "A/B test subject lines on next full-list send", desc: "Open rates declining — test curiosity vs. discount vs. product-name subject line variants" },
        { icon: "📦", label: "Expand NO BS Bundle campaign with SMS", desc: "Early signal is strong — follow up with SMS to non-openers or buyers for cross-sell" },
      ],
      later: [
        { icon: "📈", label: "Monitor source segment growth", desc: "Track how the 6 segments populate after form hidden fields go live" },
        { icon: "🔄", label: "Replenish Shopify discount codes", desc: "Generate new batches as QR program scales" },
